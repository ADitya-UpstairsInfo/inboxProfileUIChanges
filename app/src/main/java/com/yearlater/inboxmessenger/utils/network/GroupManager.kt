...
import com.yearlater.inboxmessenger.model.constants.GroupEventTypes.GROUP_CREATION
import com.yearlater.inboxmessenger.model.constants.GroupEventTypes.USER_ADDED
        ...
        return RxFirebaseDatabase.observeSingleValueEvent(FireConstants.groupsRef.child(groupId)).flatMapObservable { dataSnapshot ->
            ...
            if (groupEvent != null) {
                ...
                val mGroupEvent: GroupEvent = if (groupEvent.contextStart == groupEvent.contextEnd) {
                    GroupEvent(groupEvent.contextStart, GROUP_CREATION, "null")
                } else {
