...
/**
 * Created by yearlater on 09/01/2018.
 */
...
public class ServiceHelper {
    ...
    public static void speedUp(Context context,Float speed) {
        Intent intent = new Intent(context, AudioService.class);
        intent.setAction(IntentUtils.ACTION_SPEED_UP);
        intent.putExtra(IntentUtils.PLAYBACK_SPEED,speed);
        Log.e("service helper speedup","working");
        context.startService(intent);
