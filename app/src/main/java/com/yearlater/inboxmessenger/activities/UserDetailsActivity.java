...
import com.yearlater.inboxmessenger.adapters.MediaHorizontalAdapter;
import com.yearlater.inboxmessenger.adapters.ParticipantsAdapter;
...
import com.yearlater.inboxmessenger.model.realms.Broadcast;
...
import com.yearlater.inboxmessenger.views.dialogs.SetGroupTitleDialog;
...
public class UserDetailsActivity extends BaseActivity implements ParticipantsAdapter.OnParticipantClick, AppBarLayout.OnOffsetChangedListener {
    ...
    private void exitGroup() {
        if (!user.getGroup().isActive()) {
            ...
            AlertDialog.Builder dialog = new AlertDialog.Builder(UserDetailsActivity.this,R.style.AlertDialogCustom);
            dialog.setTitle(R.string.confirmation)
    ...
    private void init() {
        ...
        cardViewReport = findViewById(R.id.card_view_report);
            ...
            public void onPositiveClick(final String newTitle) {
                ...
                if (isGroup) {
                    getDisposables().add(groupManager.changeGroupName(newTitle, user.getUid()).subscribe(() -> {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(UserDetailsActivity.this,throwable.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
