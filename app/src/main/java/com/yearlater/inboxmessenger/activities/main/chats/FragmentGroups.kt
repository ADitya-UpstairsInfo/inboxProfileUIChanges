 ...
 * Use the [FragmentGroups.newInstance] factory method to
 * create an instance of this fragment.
 */
class FragmentGroups : BaseFragment(), GroupTyping.GroupTypingListener, ActionMode.Callback, ChatAdapter1.ChatsAdapterCallback {
    private var rvChats: RecyclerView? = null
    var adapter: ChatAdapter1? = null
    ...
    private fun listenForTypingStat() {
        typingEventListener = object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                if (i == -1) return
                val vh = rvChats!!.findViewHolderForAdapterPosition(i) as ChatAdapter1.ChatsHolder? ?: return
    ...
    private fun setTheAdapter() {
        adapter = ChatAdapter1(chatList, true, requireActivity(), this)
