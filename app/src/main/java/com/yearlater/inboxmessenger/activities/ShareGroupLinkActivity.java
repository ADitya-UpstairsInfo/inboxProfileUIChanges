...
import com.yearlater.inboxmessenger.utils.GroupLinkUtil;
...
public class ShareGroupLinkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user != null && user.getGroup() != null) {
            group = user.getGroup();
            if (group.getCurrentGroupLink() != null && group.getCurrentGroupLink().length() != 0) {
                enableClicks();
                Log.e("link",group.getCurrentGroupLink().length() +" ");
