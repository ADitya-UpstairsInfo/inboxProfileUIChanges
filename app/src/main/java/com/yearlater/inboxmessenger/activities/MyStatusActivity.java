...
import com.yearlater.inboxmessenger.adapters.MyStatusAdapter;
...
import com.yearlater.inboxmessenger.utils.ImageEditorRequest;
...
//                    }
            ...
            Log.e("hello",""+seenByRealmList.size());
            RealmHelper.getInstance().setStatusCount(status.getStatusId(),seenByRealmList.size());
                }
