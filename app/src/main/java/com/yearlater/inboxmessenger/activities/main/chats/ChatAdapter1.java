...
import com.yearlater.inboxmessenger.utils.glide.GlideApp;
...
public class ChatAdapter1 extends RealmRecyclerViewAdapter<Chat, RecyclerView.ViewHolder> {
   ...
   ChatsAdapterCallback callback;
    ...
    public ChatAdapter1(@Nullable OrderedRealmCollection<Chat> data, boolean autoUpdate, Context context, ChatAdapter1.ChatsAdapterCallback callback) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ChatAdapter1.ChatsHolder(row);
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        final ChatAdapter1.ChatsHolder mHolder = (ChatAdapter1.ChatsHolder) holder;
        if (user.isGroupBool())
        {
