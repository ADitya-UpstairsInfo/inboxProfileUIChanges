...
import com.yearlater.inboxmessenger.common.extensions.tint
...
open class BaseHolder(val context: Context, itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    open fun bind(message: Message, user: User, position: Int) {


        tvTime?.text = message.time
        tvSize?.text = message.metadata
//        Log.e("quoted", message.toString());
...
//
                ...
                Log.e("quote",quotedMessage.toString());
                ...
                tvQuotedText?.setTextColor(ContextCompat.getColor(context, R.color.quoted_received_text_color))
