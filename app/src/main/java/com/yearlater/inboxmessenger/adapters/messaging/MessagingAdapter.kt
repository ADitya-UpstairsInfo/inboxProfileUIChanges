...
import com.yearlater.inboxmessenger.adapters.messaging.holders.*
import com.yearlater.inboxmessenger.adapters.messaging.holders.base.BaseHolder
import com.yearlater.inboxmessenger.adapters.messaging.holders.base.ReceivedDeletedMessageHolder
...
/**
 * Created by yearlater on 07/08/2017.
 */
    ...
    override fun onBindViewHolder(mHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (type) {
            ...
            MessageType.SENT_AUDIO -> {
                ...
                sentAudioHolder.bind(message, user, position)
            }
            ...
            MessageType.RECEIVED_VOICE_MESSAGE -> {
                ...
                receivedVoiceMessageHolder.bind(message, user, position)
            }
            ...
            MessageType.RECEIVED_AUDIO -> {
                ...
                receivedAudioHolder.bind(message, user, position)
            }
            MessageType.RECEIVED_CONTACT -> {
                ...
                receivedContactHolder.bind(message, user, position)
            }
            ...
            MessageType.GROUP_EVENT -> {
                ...
                notSupportedTypeHolder?.bind(message, user, position)
            }
        }
    }
